...
> /mcp disable my-server       # Disable without removing (persists across sessions, v1.0.19+)
> /mcp enable my-server        # Re-enable a disabled server (persists across sessions, v1.0.19+)
